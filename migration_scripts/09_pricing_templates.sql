...
truncate table {db_new}.pricing_templates;

INSERT INTO {db_new}.pricing_templates (id, customer_id, name, description, Rent_description, Rent_rate_code_id,
                                      Rent_schedule,
